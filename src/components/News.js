...
export default class News extends Component {
  ...
  async componentDidMount() {
    let url = `https://newsapi.org/v2/top-headlines?country=us&apiKey=084fb6a7e1d643269ca873b11db5fd9d&pageSize=${this.props.pageSize}&category=${this.props.category}`;
  ...
  previous = async () => {
    console.log("hello");
    let url = `https://newsapi.org/v2/top-headlines?country=us&apiKey=084fb6a7e1d643269ca873b11db5fd9d&pageSize=${this.props.pageSize}&page=${this.state.page-1}&category=${this.props.category}`;
    let articles = await fetch(url);
    let parseddata = await articles.json();
    console.log(parseddata);
