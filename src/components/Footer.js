    ...
    return (
        ...
        <div className="row">
            <div className="col-sm-6 col-md-4 footer-navigation">
                <h3><a href="#">News<span>Project</span></a></h3>
                ...
                <p className="company-name">ListProject.com &copy; 2020</p>
            </div>
            <div className="col-sm-6 col-md-4 footer-contacts">
                <div><span className="fa fa-map-marker footer-contacts-icon"> </span>
                    <p><span className="new-line-span">21 Revolution Street</span>NEW DELHI, INDIA</p>
                </div>
